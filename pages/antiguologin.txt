    ...
    <>
      ...
      <section className="contenedor">
        <div className="card">
          ...
          {showMore ? "Inicia sesion para ver mas": "Leer mas" }
        ...
        <div className="card2">
          ...
          />
          <h3>Calendario</h3>
          <p>Aquí podrás encontrar los horarios de las carreras del F1</p>
          {readMore2 && (
            <span id="mas2">
              <p>Hola, soy Pepito</p>
          ...
          {showMore2 ? "Inicia sesion para ver mas": "Leer mas" }
